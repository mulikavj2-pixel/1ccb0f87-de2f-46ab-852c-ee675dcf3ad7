...
export const metadata: Metadata = {
  title: "IT Solutions & Digital Transformation Services | TechCorp",
  description: "Expert IT solutions, cloud infrastructure, cybersecurity, and software development services. Transform your business with our technology expertise.",
  keywords: "IT services, cloud solutions, cybersecurity, software development, digital transformation",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "TechCorp Solutions - IT Services & Digital Transformation",
    description: "Empowering businesses with cutting-edge IT solutions and innovation",
    type: "website",
  ...
  twitter: {
    ...
    description: "Expert IT services and digital transformation"
  }
};
